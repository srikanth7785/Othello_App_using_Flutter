...
List<Color> colors = [
  ...
  void setcolor(int x) {
    ...
    if((enter != 0 || currentPlayer == "System") && complete == 0 && empty != 0)
    {
      computerMoves();
    }
  }
  ...
  if(currentPlayer == "User") currentPlayer = "System";
    ...
    Timer(Duration(milliseconds: 500),(){
      ...
      if(computerEnteredornot)
      {
        ...
        {
          empty--;
          if(countingColors("White") == 0 || countingColors("Black") == 0 || empty == 0)
          {
            setState(() {
              complete = 1;
            });
    ...
    for(int rowno = 0 ; rowno < 8 ;rowno++)
    {
      for(int  colno = 0 ; colno < 8; colno++)
      {
        if(a[rowno][colno] == '-')
        {
            ...
            if (rowno > 0) currentflips = currentflips + north(rowno, colno, p,0);
            if (rowno < 7) currentflips = currentflips + south(rowno, colno, p,0);
            if (rowno > 0 && colno < 7) currentflips = currentflips + northeast(rowno, colno, p,0);
            if (rowno > 0 && colno > 0) currentflips = currentflips + northwest(rowno, colno, p,0);
            if (rowno < 7 && colno < 7) currentflips = currentflips + southeast(rowno, colno, p,0);
            if (rowno < 7 && colno > 0) currentflips = currentflips + southwest(rowno, colno, p,0);
        ...
        children: <Widget>[
                    ...
                    child: Card(
                      ...
                      elevation: 15.0,
                        ...
                        onTap: (){
                          setState(() {
                            currentPlayer = "System";
                            setcolor(50); //////***** DOESN'T MATTER WHAT NUMBER YOU ARE PASSING HERE AS A PARAMETER*****//////
          ...
          new Column(
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  new Container(
                    ...
                    decoration: new BoxDecoration(
                      ...
                      color: currentPlayer == "User" ? Colors.black : Colors.white,
                    ),
                    ...
                    child: new Center(
                      child: new Text(
                        ...
                        style: new TextStyle(
                          color: currentPlayer == "User" ? Colors.white : Colors.black,
                  ...
                  new Text(
                    countingColors("Black") < 10 ? "Black: 0${countingColors("Black")}" : "Black: ${countingColors("Black")}",
                    style: new TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                      fontSize: MediaQuery.of(context).size.width * 0.04,
              ...
              Center(
                child: new RaisedButton(
                  ...
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
                    ...
                    onPressed: () {
                      empty == 0 || complete == 1 ? print("playing again") : print("Reseting");
                      truncate();
                    }),
                  ),
                ],
              ...
              sysrow == -1 ? Container() : Positioned(
                child: Container(
                  child: Image.asset('images/Pointing.png'),
                  height: 25.0,
                  width: 25.0,
                ),
                top:  (MediaQuery.of(context).size.width * 0.127) * sysrow + 15.0 ,
                left: (MediaQuery.of(context).size.width * 0.127) * syscol + 7.0 ,
              ),
