...
class IntroPageState extends State<IntroPage> {
  static List<String> testDeviceIds = <String>[
    "4768989DE9003C8EF583D7B60EC12B4B"
  ];
...
//  testDevices: testDeviceIds, // Android emulators are considered test devices
  ...
  initState() {
    ...
    FirebaseAdMob.instance
        .initialize(appId: "ca-app-pub-3781046810533099~6890329253");
    bannerAd
      ..load()
      ..show(
